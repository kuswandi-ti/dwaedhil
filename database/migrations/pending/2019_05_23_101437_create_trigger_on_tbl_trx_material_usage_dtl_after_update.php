...
class CreateTriggerOnTblTrxMaterialUsageDtlAfterUpdate extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared('
            CREATE TRIGGER `trg_trx_matusage_dtl_after_update` 
            AFTER UPDATE ON `tbl_trx_matusage_dtl` FOR EACH ROW 
            BEGIN
    ...
    {
        DB::unprepared('DROP TRIGGER `trg_trx_matusage_dtl_after_update`');
    }
}
