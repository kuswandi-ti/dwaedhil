...
class CreateTableTrxMaterialRequestDetail extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_trx_matreq_dtl', function (Blueprint $table) {
            ...
            $table->foreign('id_raw_material')
                  ...
                  ->onUpdate('cascade');
            $table->float('qty_matreq', 12, 5)->default(0);
    ...
    {
        Schema::dropIfExists('tbl_trx_matreq_dtl');
    }
}
