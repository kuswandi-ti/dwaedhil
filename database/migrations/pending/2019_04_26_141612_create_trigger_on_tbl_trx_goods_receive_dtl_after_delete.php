...
class CreateTriggerOnTblTrxGoodsReceiveDtlAfterDelete extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared('
            CREATE TRIGGER `trg_trx_gr_dtl_after_delete` 
            AFTER DELETE ON `tbl_trx_gr_dtl` FOR EACH ROW 
            BEGIN
