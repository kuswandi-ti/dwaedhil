...
class CreateTriggerOnTblTrxAllocationFgDtlAfterDelete extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared('
            CREATE TRIGGER `trg_trx_allocfg_dtl_after_delete`
            AFTER DELETE ON `tbl_trx_allocfg_dtl` FOR EACH ROW
            BEGIN
    ...
    {
        DB::unprepared('DROP TRIGGER `trg_trx_allocfg_dtl_after_delete`');
    }
}
