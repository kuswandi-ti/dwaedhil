            ...
            <div class="modal-content">
				...
				<div class="modal-body" style="overflow: hidden;">
					<form id="modal_form_ppl_hdr" class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group has-danger row" id="form_group_id_customer">
                                    <label class="control-label text-right col-md-3">Customer <span class="text-danger">*</span></label>
                                    <div class="col-md-9">
                                        <select class="form-control form-control-danger" style="width: 100%" id="id_customer" name="id_customer"></select>
                                        <small class="form-control-feedback" id="id_customer_error"></small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group has-danger row" id="form_group_id_product">
                                    <label class="control-label text-right col-md-3">Product <span class="text-danger">*</span></label>
                                    <div class="col-md-9">
                                        <select class="form-control form-control-danger" style="width: 100%" id="id_product" name="id_product"></select>
                                        <small class="form-control-feedback" id="id_product_error"></small>
                                    </div>
                                </div>
                            </div>
                        </div>
